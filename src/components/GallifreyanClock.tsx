...
export const GallifreyanClock: React.FC = () => {
  return (
    <div className="relative w-full h-full flex items-center justify-center opacity-20 pointer-events-none">
      ...
      <div className="absolute w-[300px] h-[300px] border-2 border-tardis-glow/10 rounded-full animate-[spin-slow_45s_linear_infinite_reverse]" />
      <div className="absolute w-[200px] h-[200px] border border-tardis-glow/30 rounded-full animate-[spin-slow_30s_linear_infinite]" />
